...
;
	($.$giper_balls_requisites) = class $giper_balls_requisites extends ($.$mol_page) {
		Title(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.$.$mol_locale.text("$giper_balls_requisites_Title_title")));
			return obj;
		}
		OGRNIP_value(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ("325350000056770");
			return obj;
		}
		OGRNIP(){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ((this.$.$mol_locale.text("$giper_balls_requisites_OGRNIP_title")));
			(obj.content) = () => ([(this.OGRNIP_value())]);
			return obj;
		}
		INN_value(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ("351400789430");
			return obj;
		}
		INN(){
			const obj = new this.$.$mol_labeler();
			(obj.title) = () => ((this.$.$mol_locale.text("$giper_balls_requisites_INN_title")));
			(obj.content) = () => ([(this.INN_value())]);
			return obj;
		}
		Info(){
			const obj = new this.$.$mol_list();
		...
		title(){
			return (this.$.$mol_locale.text("$giper_balls_requisites_title"));
		}
		body(){
			return [(this.Info())];
		}
	};
	($mol_mem(($.$giper_balls_requisites.prototype), "Title"));
	($mol_mem(($.$giper_balls_requisites.prototype), "OGRNIP_value"));
	($mol_mem(($.$giper_balls_requisites.prototype), "OGRNIP"));
	($mol_mem(($.$giper_balls_requisites.prototype), "INN_value"));
	($mol_mem(($.$giper_balls_requisites.prototype), "INN"));
	($mol_mem(($.$giper_balls_requisites.prototype), "Info"));
...
(function ($) {
    var $$;
    (function ($$) {
        $mol_style_define($giper_balls_requisites, {
            Info: {
                padding: $mol_gap.text,
            },
            OGRNIP: {
...
;
	($.$giper_balls_offer) = class $giper_balls_offer extends ($.$mol_page) {
		Content(){
			const obj = new this.$.$mol_text();
			(obj.text) = () => ((this.$.$mol_locale.text("$giper_balls_offer_Content_text")));
			return obj;
		}
		title(){
			return (this.$.$mol_locale.text("$giper_balls_offer_title"));
		}
		body(){
			return [(this.Content())];
		}
	};
	($mol_mem(($.$giper_balls_offer.prototype), "Content"));
...
(function ($) {
    var $$;
    (function ($$) {
        $mol_style_define($giper_balls_offer, {
            Content: {
                padding: $mol_gap.text,
                maxWidth: '800px',
                margin: {
...
;
	($.$giper_balls_shop) = class $giper_balls_shop extends ($.$mol_page) {
		...
		Product_1(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Product_1_content()), (this.Buy_1())]);
			return obj;
		}
		Product_3_badge(){
			const obj = new this.$.$mol_paragraph();
		...
		Product_3(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Product_3_content()), (this.Buy_3())]);
			return obj;
		}
		Product_5_badge(){
			const obj = new this.$.$mol_paragraph();
		...
		Product_5(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Product_5_content()), (this.Buy_5())]);
			return obj;
		}
		Products(){
			const obj = new this.$.$mol_view();
		...
		Checkout_info(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ((this.checkout_info_content()));
			return obj;
		}
		Checkout(){
			const obj = new this.$.$mol_view();
			(obj.dom_name) = () => ("div");
			(obj.attr) = () => ({"id": "yookassa-checkout"});
			return obj;
		}
		Footer(){
			const obj = new this.$.$mol_paragraph();
	...
	($mol_mem(($.$giper_balls_shop.prototype), "Product_1_content"));
	...
	($mol_mem(($.$giper_balls_shop.prototype), "Product_3_content"));
	...
	($mol_mem(($.$giper_balls_shop.prototype), "Product_5_content"));
	...
	($mol_mem(($.$giper_balls_shop.prototype), "Checkout_info"));
	($mol_mem(($.$giper_balls_shop.prototype), "Checkout"));
...
;
	($.$giper_balls_catalog) = class $giper_balls_catalog extends ($.$mol_book2_catalog) {
		...
		Requisites(){
			const obj = new this.$.$giper_balls_requisites();
			(obj.tools) = () => ([...(this.$.$giper_balls_requisites.prototype.tools.call(obj)), (this.Spread_close())]);
			return obj;
		}
		Offer(){
			const obj = new this.$.$giper_balls_offer();
		...
		menu_foot(){
			return [(this.Support()), (this.Lights())];
		}
		spreads(){
			return {
				"lines": (this.Lines()), 
